...
struct purchseModel {
    ...
    var country:String
    var rate:String
    var avgLoading:String

    init(material:String,qty:String,country:String,rate:String,avgLoading:String) {
...
//    @IBOutlet weak var btnSupplierPlus:UIButton!
    ...
    var arrpurchaseOrderMatrialList = [purchaseOrderMatrialModel]()
...
//        btnNext.layer.masksToBounds = true
        ...
        self.tblPurchase.register(nibName, forCellReuseIdentifier: "PurchaseHeaderCell")

        self.tblPurchase.register(UINib(nibName: "PurchaseCell", bundle: nil), forCellReuseIdentifier: "PurchaseCell")
...
extension ViewController
{
    @IBAction func btnClickNext(_sender:UIButton)
    {
        for controller in self.navigationController!.viewControllers as Array {
            if controller.isKind(of: PurchaseOrderListVC.self) {
...
extension ViewController:UITableViewDelegate,UITableViewDataSource
{
    ...
    @objc func btnEditClick(_ sender:UIButton)
    {
        ...
        let vc = storyboard.instantiateViewController(withIdentifier: "UpdatePurchasePopVC") as! UpdatePurchasePopVC
    ...
    @objc func btnDeleteClick(_sender:UIButton)
    {
        ...
        { action -> Void in
            self.selectedIndex = Int(self.arrpurchaseOrderMatrialList[_sender.tag].purchaseordermaterialid)
    ...
    @objc func btnPlusClick(_sender:UIButton)
    {
       // dropDown.hide()
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        let vc = storyboard.instantiateViewController(withIdentifier: "PurchasePopVC") as! PurchasePopVC
        vc.purchaseOrderId = purchaseOrderId
        vc.delegate = self
        vc.modalPresentationStyle = .overCurrentContext
        vc.modalTransitionStyle = .crossDissolve
...
extension ViewController {
    func GetPurchaseOrderMaterialApiCall()
    {
        ...
        ApiHttpUtility.sharedUHttp.callPostHttpUtility(urlString: API.GetPurchaseOrderMaterial, params: params) { (responceJson) in
...
extension ViewController:purchaseDelegate,supplierDelegate
{
